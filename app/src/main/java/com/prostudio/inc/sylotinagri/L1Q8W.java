...
public class L1Q8W extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1_q8_w);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.home){
            ...
            Intent intent = new Intent(this,L1Q9.class);
            startActivity(intent);
