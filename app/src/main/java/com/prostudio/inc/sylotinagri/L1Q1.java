...
public class L1Q1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1_q1);

        onPause();
        showDialog();

        mediaPlayer = MediaPlayer.create(L1Q1.this, R.raw.l1b);
    ...
    public void showDialog() {
        final Dialog dialog = new Dialog(L1Q1.this);
