...
public class L1Q9 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1_q9);

        onPause();
        showDialog();

        mediaPlayer = MediaPlayer.create(L1Q9.this, R.raw.l1e);
    ...
    public void showDialog() {
        final Dialog dialog = new Dialog(L1Q9.this);
