...
public class L1Q8 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1_q8);

        onPause();
        showDialog();

        mediaPlayer = MediaPlayer.create(L1Q8.this, R.raw.l1d);
    ...
    public void showDialog() {
        final Dialog dialog = new Dialog(L1Q8.this);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.q6){
            Intent intent = new Intent(this,L1Q8W.class);
            ...
            Intent intent = new Intent(this,L1Q8R.class);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_left_zero, R.anim.slide_out_right_zero);
        }if (v.getId() == R.id.q3){
            Intent intent = new Intent(this,L1Q8W.class);
