...
public class L1Q12 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1_q12);

        onPause();
        showDialog();

        mediaPlayer = MediaPlayer.create(L1Q12.this, R.raw.l1b);
    ...
    public void showDialog() {
        final Dialog dialog = new Dialog(L1Q12.this);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.q6){
            Intent intent = new Intent(this,L1Q12W.class);
            ...
            Intent intent = new Intent(this,L1Q12R.class);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_left_zero, R.anim.slide_out_right_zero);
        }
