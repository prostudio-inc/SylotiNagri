...
public class L1Q12R extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1_q12_r);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.home){
            ...
            Intent intent = new Intent(this,L1Q12.class);
            startActivity(intent);
