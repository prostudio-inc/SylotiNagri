...
public class L1Q6W extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1_q6_w);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.home){
            ...
            Intent intent = new Intent(this,L1Q6.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(this,L1Q7.class);
            startActivity(intent);
