...
public class L1Q3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1_q3);

        onPause();
        showDialog();

        mediaPlayer = MediaPlayer.create(L1Q3.this, R.raw.l1c);
    ...
    public void showDialog() {
        final Dialog dialog = new Dialog(L1Q3.this);
