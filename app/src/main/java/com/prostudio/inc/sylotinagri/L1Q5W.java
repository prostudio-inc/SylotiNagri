...
public class L1Q5W extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1_q5_w);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.home){
            ...
            Intent intent = new Intent(this,L1Q5.class);
            startActivity(intent);
