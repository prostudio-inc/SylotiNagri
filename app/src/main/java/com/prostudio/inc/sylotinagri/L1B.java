...
public class L1B extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1b);
        onPause();
        mediaPlayer = MediaPlayer.create(L1B.this,R.raw.l1b);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.back){
            Intent intent = new Intent(this,L1A.class);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
        }
