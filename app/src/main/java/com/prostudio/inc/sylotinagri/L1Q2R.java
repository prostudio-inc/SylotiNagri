...
public class L1Q2R extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1_q2_r);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.home){
            ...
            Intent intent = new Intent(this,L1Q2.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(this,L1Q3.class);
            startActivity(intent);
