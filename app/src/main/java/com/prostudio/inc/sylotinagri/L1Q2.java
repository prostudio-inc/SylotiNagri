...
public class L1Q2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1_q2);

        onPause();
        showDialog();

        mediaPlayer = MediaPlayer.create(L1Q2.this, R.raw.l1a);
    ...
    public void showDialog() {
        final Dialog dialog = new Dialog(L1Q2.this);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.q3){
            Intent intent = new Intent(this,L1Q2W.class);
            ...
            Intent intent = new Intent(this,L1Q2R.class);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_left_zero, R.anim.slide_out_right_zero);
